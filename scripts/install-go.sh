...
# Script simple para instalar Go 1.24.4
...
if [ ! -f "/tmp/go1.24.4.linux-amd64.tar.gz" ]; then
    echo "❌ Error: Archivo go1.24.4.linux-amd64.tar.gz no encontrado en /tmp"
    echo "Descargando..."
    cd /tmp
