...
import { Server, Palette, Type, Plus, Check, AlertCircle, Trash2, Settings as SettingsIcon, Info, Github, Mail, Coffee, Code } from 'lucide-react';
                    ...
                    <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 shadow-lg">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm">Coming soon... Languages</p>
                            </div>
                        </div>
                    </div>
                </div>
