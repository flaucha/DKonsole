...
func NewServiceFactory(k8sClient kubernetes.Interface, handlersModel *models.Handlers, secretName string) *ServiceFactory {
...
func (f *ServiceFactory) NewService() *Service {
	...
	return NewService(repo, f.handlersModel)
}
