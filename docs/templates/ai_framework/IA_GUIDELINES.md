...
This document is the **single source of truth** for any AI agent working on the [Project Name] project.
...
2.  **Framework Compliance**: You must adhere to the "AI Framework". Do not deviate from the defined architecture, coding standards, or release processes.
...
- **[docs/CODING_GUIDELINES.md](./docs/CODING_GUIDELINES.md)**: Architecture, patterns, and style.
...
- **[docs/COMMANDS.md](./docs/COMMANDS.md)**: Specific command patterns the user will use to interact with you.
...
- **Verification**: Run `./scripts/ai-check.sh` (or equivalent) to verify the project state.
